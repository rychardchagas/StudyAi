...
export function Tip({ label, children }: TipProps) {
  ...
  return (
    ...
    >
      {children}
      {show && (
        <div className="absolute bottom-[calc(100%+6px)] left-1/2 -translate-x-1/2 bg-card2 border border-border2 rounded-md px-2 py-1 text-[11px] text-txt whitespace-nowrap z-50 pointer-events-none shadow-lg">
          {label}
